...
Crack the following mixed alphabet cipher by decrypting it without knowing the key. Your answer should contain (a) the plaintext; (b) the password; (c) a short explanation of your methodology; and (d) a list of the most helpful resources such as digrams, trigrams, computer tools, etc.
