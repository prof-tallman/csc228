...
Today's activity uses the classic game of *Clue* to explore the idea of metadata leakage. In information security, it is often possible to learn valuable information about a communication without directly reading encrypted messages. Many patterns that can be discovered and analyzed from the encrypted data, such as: who communicates, who stays silent, how frequently messages appear, and how information flows through a network. These clues can reveal structure and intent.

During this exercise, students will first play *Clue* normally and then replay the game with the addition of indirect information about who could answer each suggestion. The goal is to demonstrate that communication patterns themselves can become intelligence, even when the underlying data remains secret. For example, if Alice cannot answer a suggestion involving Professor Plum, the Rope, and the Kitchen, we immediately know she possesses none of those cards. If Bob also cannot answer before Charlie responds, the possibilities narrow even further.

- **Normal *Clue*:** I solve problems using revealed information.
- **Metadata *Clue*:** Hidden information leaks through patterns.

Students will intentionally exploit this metadata to gain insight into how intelligence analysts think. Over three rounds of *Clue*, they will move from observing the concept to actively using it, learning to track answers, note repeats, exploit silence, and eliminate answers. At some point they should suddenly realize: metadata analysis is a powerful technique that can be just as powerful as cryptanalysis. That realization--even if they struggle to reproduce it themselves--is the whole lesson.

#### Acknowledgements ####

The activity uses the familiar deductive structure of Hasbro's board game *Clue*. It assumes that the instructor has at least one copy of the *Clue* board game. Multiple copies would be better so that students could play in groups of 4-6 people. *Clue* is a trademark of Hasbro; this classroom activity is independently developed and is not sponsored by or affiliated with Hasbro.
...
Normal Play where students use ordinary *Clue* reasoning. During discussion time, ask the students to explain their strategy. Then explain how metadata can be used to infer additional information.

### Round 2 (~20 minutes) ###

Instructor-Led metadata analysis where the class collaborates together by looking at who answered, who could not answer, overlaps, and process of elimination. This should be the "aha" moment.
...
Encourage students to AVOID noting hesitation timing, facial expressions, and behavioral tells. This is not a game of poker where analyze minute changes in behavior. It is supposed to simulate encrypted traffic intercepts.

### Round 3 (~30 minutes~) ###

Competitive Metadata Play where students may now intentionally use metadata strategies, keep richer notes, and compete again. Let them try the out their new found deductive powers in a real game. Finish the game by comparing the difference between the student's original strategy with this new detective technique.

It's unlikely, but some students might take the lesson too far and conclude that privacy is impossible. Steer these students towards the idea that security and privacy are complicated, but not impossible. Protecting information involves more than just encrypting content.
